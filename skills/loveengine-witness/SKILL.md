...
description: Verify, install, operate, observe, and audit the LoveEngine Witness Skill and its LAN pilot. Use for LoveEngine manifests, releases, live-text sessions, Agent observation tasks, evidence bundles, dispute reviews, explicit witness voting, transcripts, or pilot recovery.
---
